...
type ArticleClient interface {
	...
	DeleteArticle(ctx context.Context, in *DeleteArticleRequest, opts ...grpc.CallOption) (*OperateReply, error)
...
func (c *articleClient) DeleteArticle(ctx context.Context, in *DeleteArticleRequest, opts ...grpc.CallOption) (*OperateReply, error) {
...
func (UnimplementedArticleServer) DeleteArticle(context.Context, *DeleteArticleRequest) (*OperateReply, error) {
